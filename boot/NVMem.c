...
* Note:		 	None.
********************************************************************/
unsigned int __attribute__((nomips16)) NVMemOperation(unsigned int nvmop)
{
    int	int_status;
    int	susp;
 ...
 ********************************************************************/
unsigned int NVMemErasePage(void* address)
{
    unsigned int res;
 ...
 ********************************************************************/
unsigned int NVMemWriteWord(void* address, unsigned int data)
{
    unsigned int res;
 ...
 ********************************************************************/
unsigned int NVMemWriteRow(void* address, void* data)
{
    unsigned int res;
 ...
 ********************************************************************/
unsigned int NVMemClearError(void)
{
    unsigned int res;
